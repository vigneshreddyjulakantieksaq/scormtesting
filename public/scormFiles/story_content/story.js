...
if (g_bLMS)
{
	document.write("<SCR" + "IPT LANGUAGE='JavaScript1.2' SRC='https://s3.ap-south-1.amazonaws.com/eksaq.com/js/scrom/comm/lms/lms.js' TYPE='text/javascript'><\/SCR" + "IPT>");
}
...
function DoOnLoad() {
    ...
    if (isMessage) {
      ...
      frame.src = 'https://s3.ap-south-1.amazonaws.com/eksaq.com/js/scrom/comm/analytics-frame.html#' + frameId;
      window.addEventListener('message', frameCb);

    } else {
      frame.src = 'https://s3.ap-south-1.amazonaws.com/eksaq.com/js/scrom/comm/analytics-frame.html?' + data + '#' + frameId;
    }
